...
namespace WinForms
{
    public partial class Form1 : Form
    {
        ...
        private void btnNegrita_Click(object sender, EventArgs e)
        {
            ...
            //Verifico si la fuente seleccionada es Negrita.
            ...
            //Establezco la nueva fuente en el Control RichTextBox.
            richTextBox.SelectionFont = nuevaFuente;

            //Realizo el Focus en el Control RichTextBox.
            richTextBox.Focus();
        }
        ...
        private void btnCentrado_Click(object sender, EventArgs e)
        {
            ...
            if (richTextBox.SelectionAlignment == HorizontalAlignment.Center)
                ...
                //Si no estaba Centrado lo alinea al Centro.
        ...
        private void txtBFuente_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if (e.KeyChar == 13)
            {
                ...
                if (txtBFuente.Text.Length > 0)
                    //Llamo al método Aplicar Tamaño al Texto.
                    AplicarTamanioText(txtBFuente.Text);
        ...
        private void txtBFuente_Validated(object sender, EventArgs e)
        {
